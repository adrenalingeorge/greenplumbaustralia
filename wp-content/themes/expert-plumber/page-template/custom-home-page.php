			...
			<div id="carouselExampleIndicators" class="carousel" data-ride="carousel"> 
			    ...
			    <div class="carousel-inner" role="listbox">
			        ...
			        <div <?php if($i == 1){echo 'class="carousel-item fade-in-image active"';} else{ echo 'class="carousel-item fade-in-image"';}?>>
						...
						<?php
							$expert_plumber_slider_effect = get_theme_mod('expert_plumber_slider_effect', '') 
						?>
			          	<div class="carousel-caption">
				            <div class="inner-carousel row">
				            	<div class="col-lg-5 col-md-5 my-auto  <?php echo ($expert_plumber_slider_effect); ?>">
					              	<h2><?php the_title(); ?></h2>
					              	<p><?php $expert_plumber_excerpt = get_the_excerpt(); echo esc_html( expert_plumber_string_limit_words( $expert_plumber_excerpt, esc_attr(get_theme_mod('expert_plumber_slider_excerpt_length','15') ) )); ?></p>
